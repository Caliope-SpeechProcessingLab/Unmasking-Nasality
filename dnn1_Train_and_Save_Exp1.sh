# Script para llamar al script python que entrena una DNN y la guarda
...
##################
baseDir=$(pwd) 
trainDir="/BDsTrain/experim1/" # Subcarpeta con BDs de entrenamiento
...
listaCorpus=(Adultos1a Adultos1b)
# micros=(Nose Mouth Mono)
